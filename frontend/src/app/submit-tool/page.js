...
export default function SubmitTool() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col items-center py-12">
      <h1 className="text-4xl font-bold mb-6">Submit Your AI Tool</h1>
      <p className="text-lg text-gray-700 mb-6">Fill out the form below to list your AI tool on our platform.</p>
